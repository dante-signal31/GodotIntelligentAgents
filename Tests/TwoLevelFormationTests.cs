...
public class TwoLevelFormationTests
{
    ...
    { 
        ...
        UsherFormationAgent formationAgent = 
            (UsherFormationAgent) _sceneRunner.FindChild("UsherWaiterObstacleManagedTwoLevelFormationAgent");
    ...
    /// </summary>
    [TestCase]
    public async Task TwoLevelFormationNonRealisticTurnUpDownTest()
    { 
        // Get references to agent and target.
    ...
    /// </summary>
    [TestCase]
    public async Task TwoLevelFormationRealisticTurnUpDownTest()
    { 
        // Get references to agent and target.
